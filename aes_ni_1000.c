...
int main(void)
{
    ...
    //running the aes_ni encryption for 1000 plaintext to record time taken 
    for (int i = 0; i < 1000; ++i)
    {
    printf("\n%ld\n", sizeof(cipherGenerated));
    ...
    printf("encriptPlainText() for 1000 plainText took %f seconds to execute \n", time_taken); 
